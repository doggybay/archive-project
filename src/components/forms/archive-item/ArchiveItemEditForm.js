...
import { Container, Paper, Typography, Grid, Card, CardMedia, List, ListItem, ListItemText, TextField } from '@material-ui/core'
...
const ArchiveItemEditForm = (props) => {
    ...
    >
      ...
      <Paper elevation={4} className={classes.detailsPaper}>
        <List>
          ...
          <ListItem>
            <ListItemText primary="Item Categoty" secondary={type} />
          </ListItem>
          <ListItem>
            <ListItemText
