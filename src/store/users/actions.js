...
export const removeAIThrUsrPending = () => ({
  type: constants.REMOVE_AI_FROM_USER_PENDING
});

export const removeAIThrUsrSuccess = (upddatedAI) => ({
  type: constants.REMOVE_AI_FROM_USER_SUCCESS,
  payload: upddatedAI
});

export const removeAIThrUsrFailed = (err) => ({
  type: constants.REMOVE_AI_FROM_USER_FAILED,
  payload: err
});